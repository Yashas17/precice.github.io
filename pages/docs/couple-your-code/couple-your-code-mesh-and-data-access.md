...
Once your adapter reaches this point, it is a good idea to test your adapter against one of the [solverdummies]([couple-your-code-prerequisites#application-programming-interface](https://github.com/precice/precice/tree/develop/examples/solverdummies)), which then plays the role of the `SolidSolver`.
